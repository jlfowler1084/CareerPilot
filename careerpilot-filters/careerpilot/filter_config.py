...
FILTER_RULES = {
    ...
    "job_alerts": {
        ...
        "from_addresses": [
            # Indeed job alerts & recommendations
            ...
            # Glassdoor - heavy hitter in your inbox
    ...
    "offers_rejections": {
        ...
        "from_addresses": [
            # Indeed employer updates come from: CompanyName <noreply@indeed.com>
            # We catch these via subject patterns rather than from address
        ],
        "subject_patterns": [
    ...
    "recruiters": {
        ...
        "from_domains": [
            ...
            "rht.com",
            # Generic recruiter domain patterns (matched separately)
        ],
        "from_addresses": [],
        "subject_patterns": [
            "opportunity",
...
USER_RECRUITER_DOMAINS_FILE = "user_recruiter_domains.txt"
...
def build_gmail_query(rule: dict) -> str:
    ...
    # (an email matching EITHER sender or subject should be caught)
    if len(parts) > 1:
